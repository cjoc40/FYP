...
@Composable
fun StatsStyle(navController: NavHostController) {
    ...
    Column(
        ...
        Column(
            ...
            Button(
                ...
                Text("Tic-Tac-Toe", color = Color.Black)
            }
            Spacer(modifier = Modifier.height(20.dp))
            Button(
                onClick = { navController.navigate("MctsStats") },
                modifier = Modifier.fillMaxWidth(),
                shape = RoundedCornerShape(8.dp),
                colors = ButtonDefaults.buttonColors(Color(255 , 135, 135))
            ) {
                Text("Connect 4", color = Color.Black)
            }
            Spacer(modifier = Modifier.height(16.dp))
            Button(
                onClick = { navController.navigate("StatCompare") },
                modifier = Modifier.fillMaxWidth(),
                shape = RoundedCornerShape(8.dp),
                colors = ButtonDefaults.buttonColors(Color.Gray)
            ) {
                Text("Compare stats", color = Color.White)
            }
        }
